...
function Cardproducts() {
  return (
    <>
      <div>
        <h1  className="custom-font sm:text-4xl text-center mt-10 mb-10 text-[#452E5D] ">Take Look At Our new Products</h1>
        <div className="text-[#452E5D] sm:flex justify-center">
          <section className="">
            <img src={softskin} className="sm:w-[582px] sm:h-[651px]  w-[282px] h-[325px] ml-auto mr-auto" alt="" />
            <p className="custom-font sm:text-3xl sm:w-[624px] sm:mt-4 w-[282px] text-center text-sm mt-4">
            ...
            <div className="flex sm:gap-[290px] mb-9 gap-20 mt-7 justify-center">
              <button className="bg-[#BCAAE0] rounded-lg sm:text-[24px] sm:pl-14 sm:pr-14 pl-9 pr-9">Buy now</button>
          ...
          <section className="">
            <img src={jarsProducts} className="sm:hidden w-[282px] h-[325px] mr-auto ml-auto" alt="" />
            <p className="custom-font sm:text-3xl sm:w-[624px] sm:mt-4  w-[282px] text-center  text-sm mt-4">
              Pamper your skin with the hydrating embrace of botanical extracts
              enriched with the soothing essence of chamomile and the
              revitalizing touch of vitamin C
            ...
            <img src={jarsProducts} className="hidden sm:block" alt="" />
          </section>
        </div>
      </div>
    </>
